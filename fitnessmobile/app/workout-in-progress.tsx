...
export default function WorkoutInProgress() {
  ...
  // In a real app, you would fetch the workout details based on workoutId
    ...
    exercises: [
      {
        ...
        duration: 45, // seconds
        rest: 15, // seconds
        metsValue: 8, // for calorie calculation
  ...
  const restDuration = currentExercise ? currentExercise.rest : 30; // default 30 seconds rest
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.exerciseContainer}>
          ...
          {/* Video demonstration (placeholder in this case) */}
          {!isRest && currentExercise?.videoUrl && (
            <View style={styles.videoContainer}>
              <View style={styles.videoPlaceholder}>
                <Text style={styles.videoPlaceholderText}>
                  {currentExercise.name} Video Demonstration
                </Text>
              </View>
            </View>
          )}
